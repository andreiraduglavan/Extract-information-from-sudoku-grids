def evaluate_results_task1(predictions_path,ground_truth_path,verbose = True, bonus=False):
    total_correct = 0
    for i in range(1,21):
...
total_correct_task1,points_task1,total_correct_bonus_task1,points_bonus_task1 = evaluate_results_task1(predictions_path,ground_truth_path,verbose=False, bonus=True)
...
total_correct_task2,points_task2,total_correct_bonus_task2,points_bonus_task2 = evaluate_results_task2(predictions_path,ground_truth_path)
